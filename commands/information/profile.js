...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const destroyer = user.id === '885368385595125791' ? true : false
        let badges = ''

        const guild = await client.guilds.fetch('1234769901416353862')
        ...
        if (destroyer === true || user.id === '885368385595125791')
            badges =
                badges +
                `\n<:Xerox_:1255435050946793553>・**[Sanujz](https://discord.com/users/885368385595125791)**`
